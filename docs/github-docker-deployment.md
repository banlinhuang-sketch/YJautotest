...
- `ghcr.io/YOUR_USERNAME/yjtest-backend:latest` - Django 后端
- `ghcr.io/YOUR_USERNAME/yjtest-frontend:latest` - Vue 前端
- `ghcr.io/YOUR_USERNAME/yjtest-mcp:latest` - MCP 服务
...
services:
  backend:
    image: ghcr.io/mg-duan/yjtest-backend:latest
  frontend:
    image: ghcr.io/mg-duan/yjtest-frontend:latest
  mcp:
    image: ghcr.io/mg-duan/yjtest-mcp:latest
```
...
services:
  backend:
    # build:
    #   context: ./YJTest_Django
    #   dockerfile: Dockerfile
    image: ghcr.io/your-github-username/yjtest-backend:latest
```
...
services:
  backend:
    image: ghcr.io/mg-duan/yjtest-backend:v1.0.0
```
...
```bash
docker image rm ghcr.io/your-github-username/yjtest-backend:latest
docker image rm ghcr.io/your-github-username/yjtest-frontend:latest
docker image rm ghcr.io/your-github-username/yjtest-mcp:latest
```
