...
- **固定Key值**: `yjtest-default-mcp-key-2026`
...
| 配置名称 | URL | 说明 |
|---------|-----|------|
| YJTest-Tools | http://mcp:8006 | 测试用例管理工具 |
...
**文件**: `YJTest_Django/accounts/management/commands/init_admin.py`
...
```bash
# 旧值
YJTEST_API_KEY=your_api_key_here

# 新值
YJTEST_API_KEY=yjtest-default-mcp-key-2026
```

**文件**: `YJTest_MCP/.env.example`
```bash
# 旧值
YJTEST_API_KEY=your_api_key_here
...
```yaml
# 旧值
- YJTEST_API_KEY=${YJTEST_API_KEY:-}

# 新值
- YJTEST_API_KEY=${YJTEST_API_KEY:-yjtest-default-mcp-key-2026}
```

### 文档更新

1. **README.md** - 添加"开箱即用"说明和快速启动链接
2. **YJTest_MCP/README.md** - 更新配置说明，强调零配置特性
...
2. 恢复 `.env.example` 中的 `YJTEST_API_KEY=your_api_key_here`
3. 修改 `docker-compose.yml`，设置 `YJTEST_API_KEY=${YJTEST_API_KEY:-}`
4. 更新文档，恢复手动配置说明
