...
ASGI_APPLICATION = "yjtest_django.asgi.application"
...
# 指定项目根路由模块。
ROOT_URLCONF = "yjtest_django.urls"
...
# 指定 WSGI 入口（传统同步部署场景）。
WSGI_APPLICATION = "yjtest_django.wsgi.application"
...
if DATABASE_TYPE == "postgres":
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "yjtest"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        ...
        "yjtest_django.permissions.DjangoModelPermissions",  # 使用扩展后的模型权限控制。
    ],
    # 默认过滤后端列表。
    ...
    "DEFAULT_RENDERER_CLASSES": (
        "yjtest_django.renderers.UnifiedResponseRenderer",
...
LOGGING = {
    ...
    "handlers": {
        ...
        "app_file": {
            "level": "INFO",
            "class": "yjtest_django.safe_log_handler.SafeTimedRotatingFileHandler",
