...
class ActuatorViewSet(viewsets.ViewSet):
    ...
    # This view serves websocket in-memory state only. Keep it independent
    # from JWT/database lookups so dashboard polling does not turn transient
    # database hiccups into 500 responses.
