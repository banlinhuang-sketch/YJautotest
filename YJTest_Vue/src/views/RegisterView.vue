  ...
  <div class="register-container">
    ...
    <div class="register-card">
      ...
      <div class="brand-section">
        ...
        <p class="brand-subtitle">{{ brandRegisterCopy }}</p>
      </div>
...
import { brandName, brandRegisterCopy } from '@/config/brand';
...
.register-container {
  background:
    ...
    radial-gradient(circle at 88% 12%, rgba(167, 210, 255, 0.56), transparent 28%),
    linear-gradient(180deg, #f7faff 0%, #edf3fa 46%, #e5edf7 100%);
}
...
.brand-logo {
  width: 84px;
  height: 84px;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.94), rgba(238, 245, 255, 0.86));
  box-shadow: 0 18px 32px rgba(10, 132, 255, 0.14);
}
...
.register-button:hover:not(:disabled) {
  transform: translateY(-1px);
  box-shadow: 0 22px 40px rgba(10, 132, 255, 0.26);
}
</style>
