  ...
  <div class="login-page">
    ...
    <div class="content-layer">
      <div class="brand-area">
        ...
        <h1 class="brand-title">{{ brandShortName }}</h1>
        <p class="brand-caption">{{ brandSubtitle }}</p>
        <p class="brand-copy">{{ brandHeroCopy }}</p>
...
import { brandFeatureTags, brandHeroCopy, brandName, brandShortName, brandSubtitle } from '@/config/brand'
...
const featureTags = brandFeatureTags
...
.login-page {
  background:
    ...
    radial-gradient(circle at 82% 14%, rgba(167, 210, 255, 0.54), transparent 28%),
    linear-gradient(180deg, #f7faff 0%, #eef3fb 45%, #e5edf7 100%);
}
...
.brand-logo {
  ...
  height: 88px;
  margin-bottom: 20px;
  filter: drop-shadow(0 18px 36px rgba(10, 132, 255, 0.14));
}
...
.launcher-aura {
  background: linear-gradient(135deg, rgba(10, 132, 255, 0.2), rgba(72, 179, 255, 0.06));
}

.launcher-icon {
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.94), rgba(236, 244, 255, 0.85));
  color: #0a84ff;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.9), 0 16px 28px rgba(10, 132, 255, 0.16);
}
...
.login-overlay {
  background: rgba(232, 239, 248, 0.36);
