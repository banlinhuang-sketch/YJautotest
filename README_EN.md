...
## Documentation
For full documentation, visit: https://mgdaaslab.github.io/YJTest/
...
- [Full deployment docs](https://mgdaaslab.github.io/YJTest/)
...
Disclaimer: This project (YJTest) is for learning and research purposes only. Users are responsible for all security risks and consequences caused by unsafe deployment (such as public exposure or missing authentication). The YJTest team is not liable for any security incidents, including data leaks or server compromise, caused by improper configuration.

**YJTest / Yijing Automation Platform** - AI-powered test case generation that makes testing smarter and development more efficient!
