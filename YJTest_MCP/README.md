...
- **YJTest_tools.py** - YJTest 测试用例工具，提供本地测试用例管理功能
...
#### YJTest Tools (YJTest_tools.py) ✨ 开箱即用

- **服务端口**: 8006
- **后端地址**: `YJTEST_BACKEND_URL`（默认：http://backend:8000）
- **API密钥**: `YJTEST_API_KEY`（默认：yjtest-default-mcp-key-2026）
...
**⚠️ 生产环境安全提示：**
- 系统会自动创建默认API Key（yjtest-default-mcp-key-2026）
- 开发环境可直接使用
