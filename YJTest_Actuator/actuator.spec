...
"""
YJTest Actuator PyInstaller 打包配置

使用方法:
    pyinstaller actuator.spec

生成文件:
    dist/YJTest_Actuator/  - 包含所有依赖的目录
    dist/YJTest_Actuator/YJTest_Actuator.exe  - 主程序
"""
...
a = Analysis(
    ...
    datas=[
        ('config.example.toml', '.'),
        ('../YJTest_Vue/public/app-icon.svg', 'data'),  # 品牌图标
        *playwright_datas,
        *pydantic_datas,
        *pydantic_core_datas,
        *pyside6_datas,
